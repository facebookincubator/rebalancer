...
const config: Config = {
  title: 'Rebalancer',
  tagline: 'A DSL and tool for solving assignment problems',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/facebookincubator/rebalancer/edit/main/',
          remarkPlugins: [
            [remarkCodeSnippets, {
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/rebalancer',
            },
            // {
            //   label: 'Discord',
