...
class XpressConstraint : public ConstraintImpl {
 public:
  explicit XpressConstraint(dashoptimization::XPRBctr constraint);

  dashoptimization::XPRBctr& get();

 private:
  dashoptimization::XPRBctr constraint_;
};
