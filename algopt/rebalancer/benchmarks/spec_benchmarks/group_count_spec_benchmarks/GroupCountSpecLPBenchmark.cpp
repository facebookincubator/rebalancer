...
BENCHMARK(GroupLimit_1000_100_50_lp) {
  runGroupLimit(1000, 100, 50, SolverType::LP_BUILD_ONLY);
}
BENCHMARK(GroupLimit_100_100_50_lp) {
  runGroupLimit(100, 100, 50, SolverType::LP_BUILD_ONLY);
}
BENCHMARK(GroupLimit_100_1000_50_lp) {
  runGroupLimit(100, 1000, 50, SolverType::LP_BUILD_ONLY);
}
BENCHMARK(GroupLimit_10000_1000_500_lp) {
  runGroupLimit(10000, 1000, 500, SolverType::LP_BUILD_ONLY);
}
BENCHMARK(GroupLimit_1000_1000_500_lp) {
  runGroupLimit(1000, 1000, 500, SolverType::LP_BUILD_ONLY);
}
