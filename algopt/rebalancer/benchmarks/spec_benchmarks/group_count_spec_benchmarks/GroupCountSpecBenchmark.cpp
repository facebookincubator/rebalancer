...
BENCHMARK(GroupLimit_1000_100_50) {
  runGroupLimit(1000, 100, 50, SolverType::LOCAL_SEARCH);
}
BENCHMARK(GroupLimit_100_100_50) {
  runGroupLimit(100, 100, 50, SolverType::LOCAL_SEARCH);
}
BENCHMARK(GroupLimit_100_1000_50) {
  runGroupLimit(100, 1000, 50, SolverType::LOCAL_SEARCH);
}

BENCHMARK(GroupLimit_10000_1000_10000_materialize) {
  runGroupLimit(10000, 1000, 10000, SolverType::MATERIALIZE_ONLY);
}
