...
BENCHMARK(Balance_10000_1000_lp_subset) {
  runBalance(10000, 1000, SolverType::LP_SUBSET_BUILD_ONLY);
}
BENCHMARK(Balance_10000_10000_lp_subset) {
  runBalance(10000, 10000, SolverType::LP_SUBSET_BUILD_ONLY);
}
BENCHMARK(Balance_100000_100_lp_subset) {
  runBalance(100000, 100, SolverType::LP_SUBSET_BUILD_ONLY);
}
BENCHMARK(Balance_100000_1000_lp_subset) {
  runBalance(100000, 1000, SolverType::LP_SUBSET_BUILD_ONLY);
}
BENCHMARK(Balance_100000_10000_lp_subset) {
  runBalance(100000, 10000, SolverType::LP_SUBSET_BUILD_ONLY);
}
