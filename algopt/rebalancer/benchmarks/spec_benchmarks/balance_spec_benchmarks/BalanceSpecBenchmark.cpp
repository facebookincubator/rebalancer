...
BENCHMARK(Balance_100_10) {
  runBalance(100, 10, SolverType::LOCAL_SEARCH);
}
BENCHMARK(Balance_1000_10) {
  runBalance(1000, 10, SolverType::LOCAL_SEARCH);
}
BENCHMARK(Balance_1000_100) {
  runBalance(1000, 100, SolverType::LOCAL_SEARCH);
}
BENCHMARK(Balance_10000_1) {
  runBalance(10000, 1, SolverType::LOCAL_SEARCH);
}
BENCHMARK(Balance_10000_10) {
  runBalance(10000, 10, SolverType::LOCAL_SEARCH);
}
