...
Demonstrates enforcing stricter datacenter diversity by requiring all replicas
of a shard to be in different datacenters (MAX 1 replica per DC per shard).

This is useful when you have 3+ datacenters and want maximum geographic diversity.
For example, with 3 DCs and 3 replicas, each replica goes to a different DC.
"""
...
def place_replicas_with_strict_dc_diversity():
    """Place replicas with strict DC diversity - each replica in different DC."""
...
if __name__ == "__main__":
    place_replicas_with_strict_dc_diversity()
