...
"""
Database Shard Placement with Pinned Critical Shards

This variation adds constraints to prevent moving shards with active operations.
Useful during rebalancing when certain shards are being backed up or migrated.
"""
...
def place_database_shards():
    ...
    # variation_start
    # Don't move shards currently being backed up
    critical_shards = ["shard0", "shard10", "shard25"]
