...
class MinimizeSquaresSpecBuilder : public SpecBuilder {
 public:
  MinimizeSquaresSpecBuilder(
 ...
 private:
  ApproximationHint getApproximationHint() const;

 private:
  interface::MinimizeSquaresSpec spec_;
};
