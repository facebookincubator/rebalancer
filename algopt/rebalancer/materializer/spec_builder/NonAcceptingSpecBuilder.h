...
class NonAcceptingSpecBuilder : public SpecBuilder {
 public:
  NonAcceptingSpecBuilder(
      std::shared_ptr<const entities::Universe> universe,
      facebook::rebalancer::interface::NonAcceptingSpec spec);
 ...
 private:
  facebook::rebalancer::interface::NonAcceptingSpec spec_;
};
