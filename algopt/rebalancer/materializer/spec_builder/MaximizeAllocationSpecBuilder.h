...
class MaximizeAllocationSpecBuilder : public SpecBuilder {
 public:
  MaximizeAllocationSpecBuilder(
 ...
 private:
  ApproximationHint getApproximationHint();

 private:
  interface::MaximizeAllocationSpec spec_;
};
