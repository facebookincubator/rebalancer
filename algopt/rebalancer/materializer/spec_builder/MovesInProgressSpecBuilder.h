...
class MovesInProgressSpecBuilder : public SpecBuilder {
 public:
  MovesInProgressSpecBuilder(
  ...
  getUpdatesInInitialAssignment() const override;

  entities::Set<entities::ObjectId> fixedObjects() const override;

 private:
  interface::MovesInProgressSpec spec_;
};
