...
class CapacityWithSupplyAndDrSpecBuilder : public SpecBuilder {
 public:
  CapacityWithSupplyAndDrSpecBuilder(
 ...
 private:
  facebook::rebalancer::interface::CapacityWithSupplyAndDrSpec spec_;
};
