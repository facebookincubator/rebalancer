...
class GroupMoveLimitSpecBuilder : public SpecBuilder {
 public:
  GroupMoveLimitSpecBuilder(
  ...
  entities::Set<entities::ObjectId> fixedObjects() const override;
 ...
 private:
  interface::GroupMoveLimitSpec spec_;
  entities::Map<entities::GroupId, double> groupToMoveLimits_;
