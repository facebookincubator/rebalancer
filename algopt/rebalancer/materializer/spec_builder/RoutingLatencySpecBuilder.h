...
class RoutingLatencySpecBuilder : public SpecBuilder {
 public:
  RoutingLatencySpecBuilder(
 ...
 private:
  ExprPtr getAverageLatency(
      entities::GroupId groupId,
      const interface::RoutingRing& originScopeItemId) const;

  interface::RoutingLatencySpec spec_;
};
