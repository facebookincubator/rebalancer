...
class ObjectAffinitiesSpecBuilder : public SpecBuilder {
 public:
  ObjectAffinitiesSpecBuilder(
 ...
 private:
  bool isObjectName(const std::string& entityName) const;

 private:
  facebook::rebalancer::interface::ObjectAffinitiesSpec spec_;
};
