...
class NestedScopeLimitSpecBuilder : public SpecBuilder {
 public:
  NestedScopeLimitSpecBuilder(
 ...
 private:
  folly::F14FastMap<entities::ScopeItemId, entities::ScopeItemId>
  getInnerToOuterScopeMapping(
      entities::ScopeId outerScopeId,
      entities::ScopeId innerScopeId) const;

  interface::NestedScopeLimitSpec spec_;
};
