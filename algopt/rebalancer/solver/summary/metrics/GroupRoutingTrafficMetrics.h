...
using GroupRoutingTrafficExpr = std::shared_ptr<GroupRoutingRing>;

class GroupRoutingTrafficMetrics : public MetricCollectionImpl<
                                       GroupRoutingTrafficKey,
                                       GroupRoutingTrafficExpr> {
 public:
  void add(
